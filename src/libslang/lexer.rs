...
mod tests {
    ...
    gen_test!(
        test_string_dq_abc_backslashdq_backslashdq,
        r#""abc\"\"""#,
        Token::String(r#"abc\"\""#.to_string())
    );

    gen_test!(test_string_dq_abc_backslashn, r#""abc\n""#, Token::String(r#"abc\n"#.to_string()));
    gen_test!(
        test_string_dq_abc_backslashn_backslashn,
        r#""abc\n\n""#,
        Token::String(r#"abc\n\n"#.to_string())
    );
    ...
    gen_test!(
        test_string_dq_abc_backslasht_backslasht,
        r#""abc\t\t""#,
        Token::String(r#"abc\t\t"#.to_string())
    );
    ...
    gen_test!(
        test_string_sq_abc_backslashsq_backslashsq,
        r#"'abc\'\''"#,
        Token::String(r#"abc\'\'"#.to_string())
    );
    ...
    gen_test!(
        test_string_sq_abc_backslashn_backslashn,
        r#"'abc\n\n'"#,
        Token::String(r#"abc\n\n"#.to_string())
    );
    ...
    gen_test!(
        test_string_sq_abc_backslasht_backslasht,
        r#"'abc\t\t'"#,
        Token::String(r#"abc\t\t"#.to_string())
    );
